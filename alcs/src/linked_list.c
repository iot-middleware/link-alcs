...
#define LINKKED_LIST_PRINTF(...)  \
    do {} while (0)
/*    do {                                                     \
        printf("\n\e[0;33m%s@line%d\t:", __FUNCTION__, __LINE__);  \
        printf(__VA_ARGS__);                                 \
        printf("\e[0m\n");                                   \
    } while (0)
*/
...
list_node_t* get_list_node (const linked_list_t *_linked_list, linked_list_compare_fp_t fp, ...)
{
    const linked_list_t *linked_list = _linked_list;
    list_node_t **p;
    va_list params;
    list_node_t* dest_node = NULL;
...
int linked_list_find (linked_list_t *_linked_list, void *data)
{
    const linked_list_t *linked_list = _linked_list;
    list_node_t **p;
    int find = 0;
