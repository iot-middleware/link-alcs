 ...
 */
#ifndef __IOT_IMPORT_AES_H__
#define __IOT_IMPORT_AES_H__
...
/**
 * @brief   以`AES-CBC-128`方式, 加密指定的明文
 *
 * @param[in] src: plain data
 * @param[in] blockNum: plain data number of 16 bytes size
 * @param[out] dst: cipher data
 ...
 * @note None.
 */
int HAL_Aes128_Cbc_Encrypt_raw (
        _IN_ const uint8_t *key,
        _IN_ const uint8_t *iv,
        _IN_ const void *src,
        _IN_ size_t blockNum,
...
/**
 * @brief   以`AES-CBC-128`方式, 解密指定的密文
 *
 * @param[in] src: cipher data
 * @param[in] blockNum: plain data number of 16 bytes size
 * @param[out] dst: plain data
 ...
 * @note None.
 */
int HAL_Aes128_Cbc_Decrypt_raw(
        _IN_ const uint8_t *key,
        _IN_ const uint8_t *iv,
        _IN_ const void *src,
        _IN_ size_t blockNum,
